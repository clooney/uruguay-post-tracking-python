...
#urlStr = ""
#requestData = "{\"tracking_number\":\"LX010874224JE\"}"
...
#urlStr = "?page=1&limit=100&created_at_min=&created_at_max=&update_time_min=&update_time_max=&order_created_time_min=&order_created_time_max=&numbers=LX010874224JE&orders=&lang=en"
#requestData = ""
#result = tracker.trackingmore(requestData, urlStr, "get")

#5 Get tracking results of a single tracking.
#urlStr = "/uruguay-post/LX010874224JE/en"
#requestData = ""
...
#urlStr = "/uruguay-post/LX010874224JE"
...
#urlStr = ""
#requestData = "{\"tracking_number\": \"LX010874224JE\",\"carrier_code\":\"uruguay-post\",\"destination_code\":\"US\",\"tracking_ship_date\": \"20180908\",\"tracking_postal_code\":\"12201\",\"specialNumberDestination\":\"UK\",\"order\":\"#123\",\"order_create_time\":\"2018/09/08 16:51\",\"lang\":\"en\"}"
#result = tracker.trackingmore(requestData, urlStr, "realtime")

#10 Modify courier code(修改运输商)
#urlStr = ""
#requestData = "{\"tracking_number\": \"LX010874224JE\",\"carrier_code\":\"uruguay-post\",\"update_carrier_code\":\"china-ems\"}"
...
#urlStr = ""
#requestData = "[{\"tracking_number\":\"LX010874224JE\",\"carrier_code\":\"uruguay-post\"},{\"tracking_number\":\"LZ448865302CN\",\"carrier_code\":\"uruguay-post\"}]"
...
#urlStr = ""
#requestData = "[{\"carrier_code\":\"uruguay-post\",\"destination\":\"US\",\"original\":\"CN\"},{\"carrier_code\":\"china-ems\",\"destination\":\"US\",\"original\":\"CN\"}]"
#result = tracker.trackingmore(requestData, urlStr, "costtime")

#16 Delete multiple tracking item(批量删除)
#urlStr = ""
#requestData = "[{\"tracking_number\":\"LX010874224JE\",\"carrier_code\":\"uruguay-post\"},{\"tracking_number\":\"LZ448865302CN\",\"carrier_code\":\"china-ems\"}]"
